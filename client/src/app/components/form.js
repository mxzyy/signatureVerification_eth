...
function Form() {
    ...
    const handleMessageChange = (event) => {
        setMessage(event.target.value); // Update state dengan nilai baru
    };
    const handleSubmit = (event) => {
        event.preventDefault(); // Mencegah reload halaman
        console.log('Message:', message); // Menampilkan nilai di console
        // Anda bisa menambahkan logika lain di sini, seperti mengirim data ke API
    };
    return (
        <>
